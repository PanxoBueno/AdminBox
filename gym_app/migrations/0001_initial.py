# Generated by Django 5.2 on 2025-04-28 20:35
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('nivel', models.CharField(choices=[('amateur', 'Amateur'), ('rookie', 'Rookie'), ('scaled', 'Scaled'), ('rx', 'Rx'), ('elite', 'Elite')], max_length=20)),
                ('email', models.EmailField(max_length=100)),
                ('plan', models.IntegerField(choices=[(0, '8 Clases'), (1, '12 Clases'), (2, '16 Clases'), (3, 'Open Box'), (4, 'Full Clases')])),
            ],
        ),
        migrations.CreateModel(
            name='Biblioteca',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('especialidad', models.CharField(choices=[('halterofilia', 'Halterofilia'), ('gimnasio', 'Gimnasio'), ('metcon', 'Metcon'), ('crossfit', 'CrossFit')], max_length=20)),
            ],
        ),
        migrations.CreateModel(
            name='Clase',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tipo_usuario', models.CharField(choices=[('admin', 'Administrador'), ('entrenador', 'Entrenador'), ('atleta', 'Atleta')], default='atleta', max_length=10)),
                ('telefono', models.CharField(blank=True, max_length=15, null=True)),
                ('groups', models.ManyToManyField(blank=True, help_text='The groups this user belongs to.', related_name='gymapp_users', related_query_name='gymapp_user', to='auth.group', verbose_name='groups')),
                ('user_permissions', models.ManyToManyField(blank=True, help_text='Specific permissions for this user.', related_name='gymapp_users', related_query_name='gymapp_user', to='auth.permission', verbose_name='user permissions')),
                ('atleta_profile', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuario', to='gym_app.atleta')),
                ('entrenador_profile', models.OneToOneField(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='usuario', to='gym_app.entrenador')),
            ],
            options={
                'verbose_name': 'user',
